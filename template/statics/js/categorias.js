...
$(document).on("ready", function () {
	...
	$(".add-to-cart").on("click", function (e) {
		...
		if($this.parents('.item-articulo-info').find('.item-switch-pack-surtido').length) {
			...
			colorSeleccionado = !esPack ? '&color=' + $this.parents('.item-articulo-info').find('.item-articulo-subinfo.item-articulo-info-surtido > .item-articulo-colores > .info-value > ul.lista-colores > li.color > span.selected').data('colorid') : '';
		}
