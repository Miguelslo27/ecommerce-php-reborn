<?php 
  ...
  $articles->number = '94';
  $articles->links  = [['Todos los artículos', '/admin/articulos/?section=lista'],['Nuevo artículo', '/admin/articulos?section=nuevo'],['Artículos eliminados', '/admin/articulos?section=eliminados']];
  ...
  $orders->number = '706';
  $orders->links  = [['Todos los pedidos', '/admin/ordenes/'],['Pedidos pendientes', '/admin/pedidos?pid=pendientes'],['Pedidos abiertos', '/admin/pedidos?pid=abiertos'],['Pedidos cerrados', '/admin/pedidos?pid=cerrados'],['Pedidos cancelados', '/admin/pedidos?pid=cancelados']];
