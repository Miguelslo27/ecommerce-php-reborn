<?php 
  ...
  $articles->number = '94';
  $articles->links  = [['Todos los artículos', '/admin/pages/list-articles'],['Nuevo artículo', '/admin/articulos?aid=nuevo'],['Artículos eliminados', '/admin/articulos?aid=eliminados']];
