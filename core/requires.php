...
require_once(CORE_LOCATION . '/lib/mailer/class.phpmailer.php');
require_once(CORE_LOCATION . '/lib/mailer/class.exception.php');
require_once(CORE_LOCATION . '/lib/mailer/class.smtp.php');
